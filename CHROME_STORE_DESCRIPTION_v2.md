...
本專案為開放原始碼專案，完整程式碼可在 GitHub 查看：
https://github.com/GsirGinRay/ai-prompts-plus

如有問題或建議，歡迎在 GitHub 提交 Issue。

## 取得更多提示詞資源

本工具由 AI投資學院+ 推薦。如需更多提示詞資源和 AI 應用技巧，可參考：
...
- All prompts and settings stored locally on your device
- No personal information or usage data collected
